...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/policies/master/_listings/akamai/cloudlets-api-v2-policies-gid,includedeleted,cloudletid-get.md
x-common:
- type: x-base

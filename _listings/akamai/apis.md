...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/akamai/cloudlets-api-v2-policies-policyid-activations-network,propertyname-get.md
x-common:
- type: x-base

...
- name: Akamai API Update a Policy Version
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/akamai/cloudlets-api-v2-policies-policyid-versions-version-put.md
x-common:
- type: x-base

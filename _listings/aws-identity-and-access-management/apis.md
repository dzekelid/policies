...
- name: AWS Identity and Access Management API Put Role Policy
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-identity-and-access-management/action-putrolepolicy-get.md
x-common:
- type: x-change-log

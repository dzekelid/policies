...
- name: AWS Identity and Access Management API Attach Role Policy
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-identity-and-access-management/action-attachrolepolicy-get.md
x-common:
- type: x-change-log

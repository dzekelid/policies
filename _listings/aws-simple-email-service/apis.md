...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/apis.md
...
- name: AWS Simple Email Service API - Get Identity Policies
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/actiongetidentitypolicies-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/actiongetidentitypolicies-get-openapi.md
- name: AWS Simple Email Service API - List Identity Policies
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/actionlistidentitypolicies-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/actionlistidentitypolicies-get-openapi.md
- name: AWS Simple Email Service API - Delete Identity Policy
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/actiondeleteidentitypolicy-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/actiondeleteidentitypolicy-get-openapi.md
- name: AWS Simple Email Service API - Put Identity Policy
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/actionputidentitypolicy-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/aws-simple-email-service/actionputidentitypolicy-get-openapi.md
x-common:
- type: x-api-gallery

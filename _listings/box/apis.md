...
- name: Box Get Retention Policy
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/box/retention-policies-policy-id-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/policies/master/_listings/box/retention-policies-policy-id-get-postman.md
x-common:
- type: x-base
